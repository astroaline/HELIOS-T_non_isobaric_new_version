...
with open('/home/aline/Desktop/PhD/HELIOS-T-master_[non_isobaric_new_version]/retrieved_results_'+planet_name+'_non_isobaric_'+model_name+'_R0_retrieved_R0.txt', 'w') as save_retrieved_results:
    for param in parameters:
...
fig.savefig('/home/aline/Desktop/PhD/HELIOS-T-master_[non_isobaric_new_version]/cornerplot_'+planet_name+'_non_isobaric_'+model_name+'_R0_retrieved_R0.png', format='png')
fig.savefig('/home/aline/Desktop/PhD/HELIOS-T-master_[non_isobaric_new_version]/cornerplot_'+planet_name+'_non_isobaric_'+model_name+'_R0_retrieved_R0.eps', format='eps')
